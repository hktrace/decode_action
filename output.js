//Tue Apr 15 2025 10:46:19 GMT+0000 (Coordinated Universal Time)
  ...
  let _0x4a1176 = {
    ...
    "init": function () {
      ...
      Object.defineProperty(_0x79a277, "id", {
        "get": function () {
          !_0x595a50 && (_0x5aef01.onOpen(), _0x595a50 = true);
          _0x40a098 = true;
          return true;
        }
      });
...
$(document).on("click", ".tag-add", function () {
  var _0x5ced1e = $(this).data("sid"),
    _0x34e40a = $(this).data("name"),
